...
class pressure_w extends StatelessWidget {
  const pressure_w({super.key});
          ...
          child: IntrinsicHeight(
            child: IntrinsicWidth(
              child: Column(
                ...
                children: [
                  Text(
                    'Warning: High Temperature. The temperature levels in the pipeline have exceeded the safe limit. Immediate action is required to avoid potential hazards.',
                    style: TextStyle(
